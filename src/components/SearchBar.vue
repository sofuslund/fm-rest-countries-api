...
<template>
    <div :class="$attrs['class']">
        <div class="relative">
            ...
            <input v-bind="attrsExceptClass" class="bg-white focus:outline-none w-full py-3 pl-20 shadow-md rounded-md placeholder-gray placeholder:font-light" type="text" placeholder="Search for a country..." />
        </div>
    </div>
</template>
